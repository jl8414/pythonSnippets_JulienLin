...
"""
The following program creates a ten megabyte data file in two different ways and times each method to
...
if __name__ == '__main__':
    ...
    for chunk_size in CHUNK_SIZE_LIST:
        ...
        print("%-15s %-15s %-15s" % (chunk_size, mmap_timer.timeit(number=TRY_NUM), fwrite_timer.timeit(number=TRY_NUM)))